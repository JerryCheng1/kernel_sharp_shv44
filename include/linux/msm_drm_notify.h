...
/* A hardware display DPMS change occurred */
#define MSM_DRM_EVENT_DPMS			0x03
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00065 */
enum {
	MSM_DRM_EVENT_DPMS_ON,
	MSM_DRM_EVENT_DPMS_LP1,
	MSM_DRM_EVENT_DPMS_LP2,
	MSM_DRM_EVENT_DPMS_OFF,
};
#endif /* CONFIG_SHARP_DISPLAY */
