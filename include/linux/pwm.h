...
#ifdef CONFIG_LEDS_SHARP /* CUST_ID_00036 */
#define PWM_STATE_PATTERN_LENGTH_MAX (48)
#endif /* CONFIG_LEDS_SHARP */
...
#endif
#ifdef CONFIG_LEDS_SHARP /* CUST_ID_00036 */
	int (*set_cust_pattern)(struct pwm_chip *chip, struct pwm_device *pwm,
				struct pwm_state *state);
	int (*get_ramp_config)(struct pwm_device *pwm, struct pwm_state *state);
#endif /* CONFIG_LEDS_SHARP */
	struct module *owner;
};
