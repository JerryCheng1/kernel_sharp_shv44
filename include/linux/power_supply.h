...
enum power_supply_battery_charger_status {
	POWER_SUPPLY_BATTERY_CHG_STS_INHIBIT,
	POWER_SUPPLY_BATTERY_CHG_STS_TRICKLE,
	POWER_SUPPLY_BATTERY_CHG_STS_PRECHARGE,
	POWER_SUPPLY_BATTERY_CHG_STS_FULLON,
	POWER_SUPPLY_BATTERY_CHG_STS_TAPER,
	POWER_SUPPLY_BATTERY_CHG_STS_TERMINATION,
	POWER_SUPPLY_BATTERY_CHG_STS_PAUSE_CHARGE,
	POWER_SUPPLY_BATTERY_CHG_STS_DISABLE_CHARGE,
	POWER_SUPPLY_BATTERY_CHG_STS_NONE,
};
#endif /* CONFIG_BATTERY_SHARP */
