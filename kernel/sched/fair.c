...
int sh_sched_load_boost_gold_plus = -16;
module_param_named(
	sh_sched_load_boost_gold_plus, sh_sched_load_boost_gold_plus, int, S_IRUGO | S_IWUSR | S_IWGRP
);

unsigned int sh_sched_load_boost_freq_gold = 1804800;
module_param_named(
	sh_sched_load_boost_freq_gold, sh_sched_load_boost_freq_gold, int, S_IRUGO | S_IWUSR | S_IWGRP
);

unsigned int sh_sched_load_boost_freq_gold_plus = UINT_MAX;
module_param_named(
	sh_sched_load_boost_freq_gold_plus, sh_sched_load_boost_freq_gold_plus, int, S_IRUGO | S_IWUSR | S_IWGRP
);
#endif /* CONFIG_SHARP_PNP_CLOCK */
