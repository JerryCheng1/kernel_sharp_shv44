...
static BLOCKING_NOTIFIER_HEAD(sm8150_a2dp_snd_notifier_list);

int register_sm8150_a2dp_snd_notifier(struct notifier_block *nb)
{
	return blocking_notifier_chain_register(&sm8150_a2dp_snd_notifier_list, nb);
}
EXPORT_SYMBOL(register_sm8150_a2dp_snd_notifier);

int unregister_sm8150_a2dp_snd_notifier(struct notifier_block *nb)
{
	return blocking_notifier_chain_unregister(&sm8150_a2dp_snd_notifier_list, nb);
}
EXPORT_SYMBOL(unregister_sm8150_a2dp_snd_notifier);

int snd_sm8150_proxy_msm_get_is_music_play(void)
{
	return blocking_notifier_call_chain(&sm8150_a2dp_snd_notifier_list, SM8150_NOTIFIER_MSM_GET_IS_MUSIC_PLAY, NULL);
}
EXPORT_SYMBOL(snd_sm8150_proxy_msm_get_is_music_play);

int snd_sm8150_proxy_msm_set_a2dp_mode(int mode)
{
	return blocking_notifier_call_chain(&sm8150_a2dp_snd_notifier_list, SM8150_NOTIFIER_MSM_SET_A2DP_MODE, &mode);
}
EXPORT_SYMBOL(snd_sm8150_proxy_msm_set_a2dp_mode);
...
static int snd_ctl_set_a2dp_mode(int __user *_state)
{
	...
	snd_sm8150_proxy_msm_set_a2dp_mode(mode);
	return 0;
}
#endif /* CONFIG_SH_AUDIO_DRIVER *//* B-003*/
