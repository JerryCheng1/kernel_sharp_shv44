...
static struct bu63164gwl_ois_reg_conf ois_init_setting1[] = {
  /* SystemCLK par1 */
  {BU63164GWL_OIS_CMD_PER, 0x62, 0x0117},     /*                          */
  {BU63164GWL_OIS_CMD_PER, 0x63, 0x059E},     /*                          */
...
int32_t shcampdaf_fw_init(struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	if((slave_info->sensor_id == 0x0318) || (slave_info->sensor_id == 0x0563)){
		uint32_t index = 0;
...
int32_t sh_ois_exit(struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	if((slave_info->sensor_id == 0x0318) || (slave_info->sensor_id == 0x0563)){
		...
		rc = bu63164gwl_actuator_write_ois(&sh_ois_info, BU63164GWL_OIS_CMD_MEM,
