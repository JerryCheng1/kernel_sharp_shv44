...
/* #define FC8350_DEBUG */
/* #define EVB */
/* #define FC8350_SC_DEBUG */
#define BBM_I2C_SPI

/* FC8350 driver configuration parameters for easy porting */
struct drv_cfg {
...
/* #define BBM_AC_DATA */
/* #define BBM_LAYER_FILTER_AB */
/* #define BBM_LAYER_FILTER_ABC */
#define BBM_LAYER_FILTER_AB_DYNAMIC_ALLOC
...
#define BBM_OSS_MNT                 0x30ac
	...
	/* DEMOD CNTRL */
#define BBM_RMONROBUSTSNR_CDAP_REQ  0x3181
#define BBM_RMONROBUSTSNR_CDX1_VAL_MSNRC 0x3182
#define BBM_RMONROBUSTSNR_CDX1_VAL_MSNRF 0x3184
...
#define BBM_CIR_TRK_EN_TH           0x3207
...
#define BBM_REF_TH_MAX_0_4          0x405b
#define BBM_REF_TH_MAX_1_4          0x405e
...
#define BBM_OTMRMNT_DECOUT_DONE     0x410a
#define BBM_OTMRMNT_DECOUT          0x4110
...
#define TS1_BUF_LENGTH              (188 * 16) /* 188 x 32 */
#define TS1_BUF_END                 (TS1_BUF_START + TS1_BUF_LENGTH - 1)
#define TS1_BUF_THR                 (TS1_BUF_LENGTH / 2 - 1)
