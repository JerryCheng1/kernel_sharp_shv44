...
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00048 */
...
extern void msm_atomic_notify_mode_dpms(struct drm_connector *connector,
	int power_mode);
#endif /* CONFIG_SHARP_DISPLAY */
		...
		void *display, u32 bl_lvl)
{
	...
	u64 bl_temp;
	int rc = 0;
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00004 *//* CUST_ID_00005 */
	...
	if ((priv != NULL) && !(priv->panel_is_connected)) {
		pr_debug("%s: panel is not connected\n", __func__);
		return 0;
	}
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00006 *//* CUST_ID_00029 */
 ...
 */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00014 */
bool dsi_display_get_cont_splash_status(struct dsi_display *display)
		...
		int power_mode, void *disp)
{
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00065 */
		rc = dsi_panel_aod_enable(display->panel, true);
#endif /* CONFIG_SHARP_DISPLAY */
	...
	case SDE_MODE_DPMS_ON:
		rc = dsi_panel_aod_enable(display->panel, false);
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00065 */
	msm_atomic_notify_mode_dpms(connector, power_mode);
#endif /* CONFIG_SHARP_DISPLAY */
	return rc;
}
...
#ifndef CONFIG_SHARP_DISPLAY /* CUST_ID_00021 */
...
#if defined(CONFIG_SHARP_DISPLAY) && defined(CONFIG_SHARP_BOOT) /* CUST_ID_00071 */
static int dsi_display_mfr_raven_30hz(struct dsi_display *display)
{
	int ret = 0;
	int cmd_cnt;
	struct dsi_cmd_desc *cmds;
	static unsigned char cmd_addr_value[][26] = {
		{0xDE, 0x04},
		{0xEB, 0x00,
		       0x79,
		       0x00,
	...
	static struct dsi_cmd_desc mfr_cmd[] = {
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, cmd_addr_value[0], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_LONG_WRITE, MIPI_DSI_MSG_USE_LPM,
			0, 0, 26, cmd_addr_value[1], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_LONG_WRITE, MIPI_DSI_MSG_USE_LPM,
			0, 0, 18, cmd_addr_value[2], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, cmd_addr_value[3], 0, 0}, 1, 0},
	};
...
int dsi_display_post_enable(struct dsi_display *display)
{
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00007 */
	if (bl_tmp) {
		dsi_display_set_backlight(display->drm_conn, display, bl_tmp);
		bl_tmp = 0;
	}
#endif /* CONFIG_SHARP_DISPLAY */
	...
	if ((boot_mode == SH_BOOT_D) || (boot_mode == SH_BOOT_F_F)) {
		dsi_display_mfr_raven_30hz(display);
	}
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00033 */
late_initcall(dsi_display_register);
#else
