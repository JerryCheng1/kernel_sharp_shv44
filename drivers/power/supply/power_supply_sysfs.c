...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(qi_suspend),
	POWER_SUPPLY_ATTR(received_power),
	...
	POWER_SUPPLY_ATTR(voltage_max),
	POWER_SUPPLY_ATTR(maximum_power),
	POWER_SUPPLY_ATTR(online),
	...
	POWER_SUPPLY_ATTR(battery_charger_status),
	POWER_SUPPLY_ATTR(voltage_max_aged),
	POWER_SUPPLY_ATTR(ibatt_full),
	POWER_SUPPLY_ATTR(vbatt_full),
