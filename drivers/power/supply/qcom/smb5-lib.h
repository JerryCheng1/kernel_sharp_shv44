...
#define DC_SRC_VOTER			"DC_SRC_VOTER"
#define DETACH_ATTACH_USB_VOTER "DETACH_ATTACH_USB_VOTER"
...
#ifdef CONFIG_BATTERY_SHARP
#define DC_AICL_THRESHOLD_VOTER		"DC_AICL_THRESHOLD_VOTER"
#endif	/* CONFIG_BATTERY_SHARP */
...
#define FV_AGED_VOTER		"FV_AGED_VOTER"
#endif /* CONFIG_BATTERY_SHARP */
...
struct smb_charger {
	...
	struct delayed_work reattach_usb_work;
	struct delayed_work weak_dc_charger_wa;
#endif /* CONFIG_BATTERY_SHARP */
	...
	bool		dcin_reverse_boost_wa_flag;
#endif /* CONFIG_BATTERY_SHARP */
};
...
int smblib_get_prop_batt_charger_status(struct smb_charger *chg, union power_supply_propval *val);
