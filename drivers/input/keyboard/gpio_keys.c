...
ATTR_SHOW_FN_COUNT(KEY_VOICESEARCH);
...
ATTR_STORE_FN_COUNT(KEY_VOICESEARCH);
...
static DEVICE_ATTR(assistant, S_IWUSR | S_IRUGO,
		   gpio_keys_show_count_KEY_VOICESEARCH,
		   gpio_keys_store_count_KEY_VOICESEARCH);
